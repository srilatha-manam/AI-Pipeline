...
from utils.text_classification.text_dislitbert_classification_preprocess import fetch_data, tokenize_data
...
def train_model_distilbert():
    try:
        ...
        encodings_train = tokenize_data(X_train["processed_text"], model_type="distilbert")
        encodings_val = tokenize_data(X_val["processed_text"], model_type="distilbert")
        ...
        model, tokenizer = ModelManager.load_distilbert_model()
        ...
        # Save model
        save_path = "models/distilbert_emotion_classifier"
        os.makedirs(save_path, exist_ok=True)
        model.save_pretrained(save_path)
        tokenizer.save_pretrained(save_path)
        logger.info(f"DistilBERT model saved at {save_path}")
