...
from inference_server.textclassification.text_classification_dislitbert_inference import predict_emotion_distilbert, emotion_label_map
from utils.text_classification.text_dislitbert_classification_preprocess import fetch_data
...
def evaluate_model():
    ...
    predictions = [predict_emotion_distilbert(text) for text in X_test["processed_text"].tolist()]
